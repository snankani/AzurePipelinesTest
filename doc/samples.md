...
5. [Open items in browser](samples.md#open-items-in-browser)
6. [Use the Azure DevOps Extension in a release pipeline](samples.md#use-the-azure-devops-extension-in-a-release-pipeline)
7. [Use the Azure DevOps Extension with YAML](samples.md#use-the-azure-devops-extension-with-yaml)
8. [Use policy configuration file to configure policies](samples.md#use-policy-configuration-file-to-configure-policies)
